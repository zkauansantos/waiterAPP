...
export default function useMain() {
	...
	useEffect(() => {
		Promise.all([
			axios.get('http://192.168.100.85:3001/categories'),
			axios.get('http://192.168.100.85:3001/products'),
	...
	function handleSelectCategory (categoryId: string) {
		const route = !categoryId
			? 'http://192.168.100.85:3001/products'
			: `http://192.168.100.85:3001/categories/${categoryId}/products`;
